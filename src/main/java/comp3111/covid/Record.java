...
public class Record {
	...
	public static int getTotalCases(Vector<Record> records, String isoCode, LocalDate date) {
		int totalCases = 0;
	...
	public static int getTotalDeaths(Vector<Record> records, String isoCode, LocalDate date) {
		int totalDeaths = 0;
		for(Record record : records) {
			if(record.getCountry() == isoCode && record.getDate().isBefore(date)) {
